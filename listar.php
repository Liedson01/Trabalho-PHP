...
<body>
	...
	if($r){
		...
		<tr>
			...
			<td width="60px"><a href="?excluir=<?php echo $result['numero']; ?>" onclick="return confirm('Deseja Realmente Excluir?');">Excluir</td>
			<td><a href="update.php?id=<?php echo $result['numero'];?>&nome=<?php echo $result['nome']; ?>&sexo=<?php echo $result['sexo']; ?>" onclick="return confirm('Deseja Realmente atualizar?');"> Editar</td>
		</tr>
